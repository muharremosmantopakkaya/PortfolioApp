...
<div style="display:flex; flex-wrap: wrap; justify-content: space-between; margin-top: 30px;">
  <img src="promptgorsel/view1.png" alt="View 1" style="width:40%; margin-top: 30px;">
  <img src="promptgorsel/view2.png" alt="View 2" style="width:40%; margin-top: 30px;">
  <img src="promptgorsel/touchprompt.png" alt="Touch Prompt" style="width:40%; margin-top: 30px;">
</div>
